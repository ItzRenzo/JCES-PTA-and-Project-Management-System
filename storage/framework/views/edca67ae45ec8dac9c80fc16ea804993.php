...
function messagePopup() {
    return {
        ...
        sendMessage() {
            ...
            let url, data;
            if (this.form.type === 'announcement') {
                url = '<?php echo e(route('administrator.announcements.store')); ?>';
                data = {
                ...
                url = '<?php echo e(route('administrator.schedules.store')); ?>';
                data = {
                    title: this.form.title,
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => window.location.href = '<?php echo e(route('administrator.announcements')); ?>', 1000);
                } else {
...
<?php /**PATH C:\J. Cruz Sr. Elementary School Project\JCES-PTA-and-Project-Management-System\resources\views/administrator/message/index.blade.php ENDPATH**/ ?>