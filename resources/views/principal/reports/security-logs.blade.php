...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Authentication and security events monitoring</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">{{ $logs->total() }} security events found</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <p class="text-lg font-medium">No security logs found</p>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-3">
                ...
                @if($logs->where('action', 'failed_login')->count() > 10)
                ...
                <div class="flex items-center gap-2 text-green-600">
                    ...
                    Login security looks good
                </div>
                @endif
                
                @if($logs->pluck('ip_address')->unique()->count() > 50)
                <div class="flex items-center gap-2 text-yellow-600">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                    </svg>
                    High number of unique IP addresses accessing the system
                </div>
                @else
                <div class="flex items-center gap-2 text-green-600">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    IP access patterns appear normal
                </div>
                @endif
            </div>
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    ...
                    <li class="flex items-start gap-2">
                        ...
                        Regular review of security logs for compliance
                    </li>
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-blue-500 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
