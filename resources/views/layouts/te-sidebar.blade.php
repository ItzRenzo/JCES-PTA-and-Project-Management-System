        ...
        <div class="w-52 bg-gradient-to-b from-green-500 to-green-600 flex flex-col">
            ...
            <nav class="flex-1 px-3 py-6 space-y-2">
                <a href="{{ route('teacher.dashboard') }}" 
                   class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('teacher.dashboard') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                ...
                <a href="{{ route('teacher.users') }}" 
                   class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('teacher.users') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
