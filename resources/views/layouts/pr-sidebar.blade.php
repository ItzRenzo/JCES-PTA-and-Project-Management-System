        ...
        <div class="w-52 bg-gradient-to-b from-green-500 to-green-600 flex flex-col">
            ...
            <nav class="flex-1 px-3 py-6 space-y-2">
                   ...
                   class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.dashboard') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    ...
                    <span>Dashboard</span>
                                 ...
                                 <a href="{{ route('principal.announcements') }}" 
                                     class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.announcements') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span>Announcement</span>
                                ...
                                <a href="{{ route('principal.projects.index') }}" 
                                     class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.projects*') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span>Projects</span>
                     ...
                     <a href="{{ route('principal.contributions.index') }}" 
                         class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.contributions*') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="{{ route('principal.users') }}" 
                   class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.users') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="{{ route('principal.reports') }}" 
                   class="flex items-center gap-3 px-4 py-3 text-white {{ request()->routeIs('principal.reports*') ? 'bg-green-700' : 'hover:bg-green-700' }} rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="p-4 border-t border-green-700">
                ...
                <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-4 py-3 text-white hover:bg-green-700 rounded-lg font-medium transition-colors w-full">
                    ...
                    <div class="text-white">
                        <div class="text-sm font-semibold">{{ Auth::user()->name ?? Auth::user()->username ?? 'Principal' }}</div>
