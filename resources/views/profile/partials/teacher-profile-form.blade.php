<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Manage your teacher account information and academic details.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="pt-4 border-t border-gray-200">
            <h3 class="text-md font-medium text-gray-900 mb-4">Academic Information</h3>
            <div class="bg-amber-50 p-4 rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <x-input-label for="username" :value="__('Teacher ID')" />
                        <x-text-input id="username" name="username" type="text" class="mt-1 block w-full bg-gray-100" :value="$user->username" readonly />
                        <p class="text-xs text-gray-500 mt-1">Teacher ID cannot be changed</p>
                    </div>
                    <div>
        ...
        <div class="pt-4 border-t border-gray-200">
            <h3 class="text-md font-medium text-gray-900 mb-4">Account Overview</h3>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xs text-green-600 mt-1">
                                Account created: {{ $user->created_at ? $user->created_at->format('M d, Y') : 'Unknown' }}
                            </p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-amber-800">
                                Last Access: {{ $user->last_login ? $user->last_login->format('M d, Y g:i A') : 'First time login' }}
                            </p>
                        </div>
                    </div>
                </div>
