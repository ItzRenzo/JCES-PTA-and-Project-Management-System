...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-600">{{ $failedActionsCount > 0 ? 'Medium' : 'High' }}</p>
                </div>
                <div class="w-12 h-12 {{ $failedActionsCount > 0 ? 'bg-yellow-100' : 'bg-green-100' }} rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 {{ $failedActionsCount > 0 ? 'text-yellow-600' : 'text-green-600' }}" fill="currentColor" viewBox="0 0 20 20">
    ...
    <!-- System Information -->
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Administrator System Information</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                ...
                <h4 class="font-medium text-gray-900">Immutable Audit Trail</h4>
                <p class="text-sm text-gray-600 mt-1">All activities are logged to an immutable audit trail for compliance and security purposes.</p>
            </div>
            <div class="text-center">
                ...
                <h4 class="font-medium text-gray-900">Real-time Monitoring</h4>
                <p class="text-sm text-gray-600 mt-1">System activities are monitored in real-time with detailed timestamps and user information.</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-sm text-gray-600 mt-1">All logging meets security compliance standards with IP tracking and session management.</p>
            </div>
        </div>
    </div>
</div>
